...
namespace Finaltec.Hart.Analyzer.View.UserControls
{
    ...
    public class ConnectMenuItem : MenuItem
    {
        ...
        /// </summary>
        public static readonly DependencyProperty IsConnectedProperty = DependencyProperty.Register("IsConnected", typeof(Boolean), typeof(ConnectMenuItem), new PropertyMetadata(false));
